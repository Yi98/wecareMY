<template>
  <v-app>
    <v-app-bar app color="white" height="70" dense flat>
    ...
    <v-content>
      <section id="hero">
        <v-row no-gutters>
          <v-img height="60vh" src="../assets/hero.jpg">
      ...
      <v-form v-model="valid" id="index-form">
        <v-container>
          <h2 class="pt-4">Find orphanages / old folks' homes around you</h2>
          <v-row>
            <v-col cols="12" md="5" class="text-center">
              <v-select :items="items" label="State" required></v-select>
            </v-col>

            <v-col cols="12" md="5" class="text-center">
              <v-select :items="items" label="City" required></v-select>
            </v-col>

            <v-col cols="12" md="2" class="text-center">
              <v-btn x-large elevation="0">Search</v-btn>
            </v-col>
          </v-row>
        </v-container>
      </v-form>
      ...
      <section id="about-me">
        ...
        <v-container class="text-center">
          <h2 class="display-2 font-weight-bold mb-12">ABOUT WecareMY</h2>

          <v-responsive
            class="mx-auto title font-weight-light mb-11"
            max-width="720"
          >Establish on year 2020, WecareMY is a Non-Governmental Organisation (NGO) that aims to bring help to people who are in need. We have one and the only goal which is make the world a better place for everyone. We care about you!</v-responsive>
          ...
          <v-btn color="grey" href="https://vuetifyjs.com" outlined large>
            <span class="grey--text text--darken-1 font-weight-bold">Know more</span>
          </v-btn>
        </v-container>
      ...
      <section id="features" class="grey lighten-3">
        ...
        <v-container class="text-center">
          <h2 class="display-2 font-weight-bold mb-3">How can you help?</h2>
      ...
      <v-sheet id="contact" color="#333333" dark tag="section" tile>
        ...
        <v-container>
          <h2 class="display-2 font-weight-bold mb-3 text-center">Contact WecareMY</h2>
    ...
    <v-footer class="justify-center" color="#292929" height="100">
      ...
      >&copy; {{ (new Date()).getFullYear() }} WecareMY — Made with 💜 by Ng Yi</div>
    </v-footer>
  </v-app>
</template>
